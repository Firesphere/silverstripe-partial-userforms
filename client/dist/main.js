...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__partialuserforms_partialsubmission__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__partialuserforms_partialstorage__ = __webpack_require__(79);
...
var buttons = function buttons() {
  return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_array_from___default()(document.body.querySelectorAll('form.userform ul li.step-button-wrapper button'));
};
var formElements = function formElements() {
  return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_array_from___default()(document.body.querySelectorAll('form.userform [name]'));
};
...
var getElementValue = function getElementValue(element, fieldName) {
  ...
  if (element.getAttribute('type') === 'checkbox') {
    ...
    var checkedElements = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_array_from___default()(document.body.querySelectorAll(_name));
    var valueArray = [];
